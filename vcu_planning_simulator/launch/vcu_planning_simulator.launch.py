...
def launch_setup(context, *args, **kwargs):
    ...
    vcu_planning_simulator_node = Node(
        package="vcu_planning_simulator",
        executable="vcu_planning_simulator_exe",
        name="vcu_planning_simulator",
    ...
    group = GroupAction([vcu_planning_simulator_node, map_to_odom_tf_publisher])
...
def generate_launch_description():
    ...
    add_launch_arg(
        "vehicle_characteristics_param_file",
        [
            FindPackageShare("vcu_planning_simulator"),
    ...
    add_launch_arg(
        ...
        [
            FindPackageShare("vcu_planning_simulator"),
            "/param/vcu_planning_simulator_default.param.yaml",
        ],
