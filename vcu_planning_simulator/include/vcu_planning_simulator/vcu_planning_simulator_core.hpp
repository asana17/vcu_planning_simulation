...
#ifndef VCU_PLANNING_SIMULATOR__VCU_PLANNING_SIMULATOR_CORE_HPP_
#define VCU_PLANNING_SIMULATOR__VCU_PLANNING_SIMULATOR_CORE_HPP_

#include "rclcpp/rclcpp.hpp"
#include "vcu_planning_simulator/vehicle_model/sim_model_interface.hpp"
...
class PLANNING_SIMULATOR_PUBLIC VcuPlanningSimulator : public rclcpp::Node
{
public:
  explicit VcuPlanningSimulator(const rclcpp::NodeOptions & options);
...
private:
  ...
  rclcpp::Subscription<SteeringReport>::SharedPtr sub_steer_report_;
  ...
  GearReport current_gear_report_;
  GearCommand current_manual_gear_cmd_;
  SteeringReport current_steer_report_;
  VelocityReport current_velocity_report_;
...
#endif  // VCU_PLANNING_SIMULATOR__VCU_PLANNING_SIMULATOR_CORE_HPP_
